        ...
        <div className={styles.midFooter}>
          ...
          <div className={styles.bottomFooter}>
            <div className={styles.leftSection}>
              <p>
                <span className={styles.text}>© 2024 Airbnb, Inc.</span>
              </p>
              <p>
                <span>.</span>
              ...
              <p>
                <span>.</span>
                <span className={styles.text}>Sitemap</span>
              </p>
              <p>
                <span>.</span>
              ...
              <p>
                <span>.</span>
                <span className={styles.text}>Your Privacy Choices</span>
              </p>
            ...
            <div className={styles.rightSection}>
              <div className={styles.flex}>
                ...
                <span className={styles.hoverLink}>English (US)</span>
              </div>
              <div className={styles.flex}>
                <span>
                  $ <span className={styles.hoverLink}>USD</span>
                </span>
              </div>
              <div className={`${styles.flex} ${styles.hoverIcon}`}>
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 32 32"
